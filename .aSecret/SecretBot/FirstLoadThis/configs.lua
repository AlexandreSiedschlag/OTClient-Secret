...
-- make SecretBot config dir
if not g_resources.directoryExists("/bot/".. configName .."/SecretBot/Profiles/") then
  g_resources.makeDir("/bot/".. configName .."/SecretBot/Profiles/")
end

-- make profile dirs
for i=1,10 do
  local path = "/bot/".. configName .."/SecretBot/Profiles/profile_"..i
...
HealBotConfig = {}
local healBotFile = "/bot/" .. configName .. "/SecretBot/Profiles/profile_".. profile .. "/HealBot.json"
AttackBotConfig = {}
local attackBotFile = "/bot/" .. configName .. "/SecretBot/Profiles/profile_".. profile .. "/AttackBot.json"
SuppliesConfig = {}
local suppliesFile = "/bot/" .. configName .. "/SecretBot/Profiles/profile_".. profile .. "/Supplies.json"
...
function SecretBotConfigSave(file)
  -- file can be either
  --- heal
  --- atk
  --- supply
