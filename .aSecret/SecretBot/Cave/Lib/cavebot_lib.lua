...
local lastConfig = ""
config = Config.setup("SecretBot/Cave/Scripts", configWidget, "cfg", function(name, enabled, data)
...
CaveBot.setCurrentProfile = function(name)
  if not g_resources.fileExists("/bot/"..botConfigName.."/SecretBot/Cave/Scripts/"..name..".cfg") then
