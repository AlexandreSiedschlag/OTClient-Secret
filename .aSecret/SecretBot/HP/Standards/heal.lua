...
macro(100, function()
  ...
  if currentSettings.Delay and SecretBot.isUsing then return end
  if currentSettings.MessageDelay and SecretBot.isUsingPotion then return end
