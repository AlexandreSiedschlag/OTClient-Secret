...
local skills = {
  ...
  { name = "Crit Chance", data = {}, id = 7, enabled = true },
  { name = "Crit Damage", data = {}, id = 8, enabled = false },
  { name = "Life Leech Chance", data = {}, id = 9, enabled = true },
  { name = "Life Leech Amount", data = {}, id = 10, enabled = true },
  { name = "Mana Leech Chance", data = {}, id = 11, enabled = true },
  { name = "Mana Leech Amount", enabled = true , data = {}, id = 12 },
